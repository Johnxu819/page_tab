...
class ViewController: UIViewController, UIPageViewControllerDataSource,UIPageViewControllerDelegate
{
  ...
  override func viewDidLoad()
  {
    ...
    pageTab=PageTab(frame: CGRectMake(0,0, view.frame.size.width,60))
    ...
    pageViewController!.view.frame = CGRectMake(0, 60, view.frame.size.width, view.frame.size.height-60);
